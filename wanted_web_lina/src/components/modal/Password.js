...
import { closePWMoAction } from "../../redux/actions/passwordModal";
import { openPWChangeMoAction } from "../../redux/actions/passwordChangeModal";
...
const Password = () => {
    ...
    const onSubmit = (data) => {
        axios.post("https://prod.wanted-a.online/users/login",{
            email: `${email}`,
            password: `${password}`,
        })
        .then(res => {
    ...
    const openPWChangeMoRedux = () => {
        dispatch(openPWChangeMoAction());
    }
        ...
        <Outline>
            <div className="section">
                <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="password-option" onClick={openPWChangeMoRedux()}>비밀번호 초기화/변경</div>
                </form>
            </div>
        </Outline>
    )
