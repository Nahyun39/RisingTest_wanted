...
import CareerCard from "../common/EventCard";
...
const listData = [
    {
        subject: "개발",
        thumNail:
          "https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fevents%2F2779%2F95bc87a5.jpg&w=1200&q=90",
        title: "프리온보딩 QA 챌린지 4월",
        desc: "2023.03.15 (수) ~ 2023.03.30 (목)",
        info: "#교육 #취업/이직 #개발",
    },
    {
        subject: "개발",
    ...
    },
    {
        subject: "개발",
        thumNail:
          "https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fevents%2F2759%2F4c071b44.jpg&w=1200&q=90",
        title: "이번달 인기 아티클 Top5 | Monthly Pick 3월",
        desc: "2023.03.15 (수) ~ 2023.03.31 (금)",
        info: "경영/전략 #개발 #시리즈",
    },
    {
        subject: "개발",
  ...
  const EventFilter = () => {
    ...
    useEffect(() => {
      axios.get("https://prod.wanted-a.online/events",{
          })
          .then(res => {
              console.log(res);
              setShowListData(res.data.result);
          })
    ...
    return (
      <Section>
        ...
        {/* <div>
            <button onClick={() => setOpenModal(true)}>필터 및 정렬</button>
